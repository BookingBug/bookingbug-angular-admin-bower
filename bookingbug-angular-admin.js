...
(function() {
  ...
  angular.module('BB.Models').factory("Admin.BookingModel", function($q, BBModel, BaseModel, BookingCollections, $window) {
    var Admin_Booking;
    return Admin_Booking = (function(superClass) {
      ...
      Admin_Booking.$query = function(params) {
        ...
        if (existing && !params.skip_cache) {
          ...
          company.$get('bookings', params).then(function(collection) {
...
(function() {
  ...
  angular.module('BB.Models').factory("Admin.ClientModel", function(ClientModel, $q, BBModel, $log, $window, ClientCollections) {
    var Admin_Client;
    return Admin_Client = (function(superClass) {
      ...
      Admin_Client.$query = function(params) {
        ...
        if (company.$has('client')) {
          ...
          company.$get('client', params).then(function(resource) {
            var client;
...
(function() {
  ...
  angular.module('BB.Models').factory("Admin.CompanyModel", function(CompanyModel, AdminCompanyService, BookingCollections, $q, BBModel) {
    var Admin_Company;
...
(function() {
  ...
  angular.module('BB.Models').factory("Admin.LoginModel", function($q, AdminLoginService, BBModel, BaseModel) {
    var Admin_Login;
